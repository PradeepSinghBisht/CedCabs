                    ...
                    <div class="navbar-nav ml-auto" id="navbtn">
                        ...
                        <?php 
                            if (isset($_SESSION['userdata'])) {
                                echo '<a class="nav-item nav-link ml-3" href="riderequest.php">Ride Request</a>
                                      <a class="nav-item nav-link mx-3" href="allusers.php">All Users</a>
                                      <a class="nav-item nav-link mx-3" href="allrides.php">All Rides</a>
                                      <a class="nav-item nav-link ml-3" href="location.php">Update Location</a>';
                            } else {
