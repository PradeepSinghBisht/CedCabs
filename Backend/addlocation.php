                        ...
                        <div class="container">
                            ...
                            <form action="#" method="POST">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-control" id="name" name="locationname" placeholder="Enter New Location" pattern="[A-Za-z]{1,}[A-Za-z0-9 ]{0,}" required>
                                </div>
                                <div class="form-group">
                                    <label for="distance">Distance</label>
                                    <input type="text" class="form-control" id="distance" name="distance" placeholder="Distance" pattern="[0-9]{1,}[.]{0,1}[0-9]{0,}" required>
                                </div>
                                <div class="form-group">
