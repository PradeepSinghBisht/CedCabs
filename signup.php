		...
		<div class="col-md-6 col-lg-6 col-sm-10 mb-4" id='abc'>
			...
			<form action="signup.php" method="POST">
                <div class="form-group " style="padding: 5px 0px;">
					...
					<input type="text" class='form-control' name="username" pattern="[A-Za-z]{1,}[A-Za-z0-9]{0,}" required>
				</div>
                <div class="form-group" style="padding: 5px 0px;">
					<label for='name'>Name:</label>
					<input type="text" class='form-control' name="name" pattern="[A-Za-z]{1,}[A-Za-z ]{0,}[A-Za-z]{1}" required>
				</div>
				<div class="form-group " style="padding: 5px 0px;">
					<label for='mobile'>Mobile (10 digit):</label>
